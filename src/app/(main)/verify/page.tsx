  ...
  return (
    <div className="flex size-full flex-col items-center mt-20 md:justify-center md:mt-0 text-center">
      ...
      <div className="text-center">
          <p className="text-neutral mt-5">Please open your email and click the link to continue</p>
          <p className="text-neutral mt-2">The link will be valid for 24 hours. If you don&apos;t receive an email, check your spam folder.</p>
      </div>
    </div>
  );
}
